...
const ProfileSponsor = () => {
  ...
  const decodedProfileSupport = supportInfo ? decodeURIComponent(supportInfo.profileSupport) : 'Đang tải thông tin...';

  return (
    <div className="game-transaction d-flex flex-column flex-fill">
      <div className="container flex-fill">
        <div className="row mt-2 mb-4">
          <PageTitle to="/tai-khoan/thong-tin" title="Hồ sơ tài trợ" />
        </div>
        <textarea
          style={{
